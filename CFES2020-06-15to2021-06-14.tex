...
I attempt to provide access to as much of my work as possible using public GitHub repositories. GitHub is a free service for backing up and sharing documents on the web. Repositories which I have updated during the reporting period are listed in Table \ref{repolist}. The document you are reading, all previous versions, and related data are stored in a public GitHub directory at \url{https://github.com/aubreymoore/CFES2020-22}. The document can be read online or downloaded as a PDF from \url{https://github.com/aubreymoore/CFES2020-22/CFES2020-26-15toCFES2021-06-14.pdf}.
...
I will continue to create and maintain GitHub repositories to share my work as part of the \href{https://en.wikipedia.org/wiki/Open_science}{open science} movement.
\end{comment}
\include{repolist-2020-06-15to2021-06-14}
