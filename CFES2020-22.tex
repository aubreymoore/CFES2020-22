...
\addbibresource{MooreAfter2019.bib}    % From the My Library in my Zotero
...
\addbibresource{InPreparation.bib}     % saved search for "In preparation" in Extras
...
On the last Friday of each month during Spring Term 2019, I put on a miniprogram for four consecutive groups of young children. Activities included:
\begin{itemize}
